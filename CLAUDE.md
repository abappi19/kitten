...
This is a Claude Skills repository for **Kitten Bot** — an AI bot persona embodying the engineering philosophy of Bappi, a Mobile Application Developer at Tulip Tech Ltd. No build step, no package.json — this is pure configuration and documentation that teaches Claude how to behave.
